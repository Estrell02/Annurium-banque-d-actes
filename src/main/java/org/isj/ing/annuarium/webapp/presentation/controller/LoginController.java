...
public class LoginController {
	...
	public ModelAndView login(){
		final ModelAndView modelAndView = new ModelAndView();//si on ne veux pas prendre en compte le model
	...
	public ModelAndView createNewUser(@Valid User user, BindingResult bindingResult) {
		...
		if (userExists != null) {
			...
			.rejectValue("email", "error.user",
					"There is already a user registered with the email provided");//gestion des erreurs a la page registration
		}
